    ...
    <div className="task-center">
      <header className="task-center__header">
        <div className="task-center__heading">
          <span className="task-center__eyebrow">Shared family dashboard</span>
          <h1>Family task center</h1>
          <p className="task-center__subtitle">
            Stay organized together with real-time updates, collaborative planning, and gentle reminders.
          </p>
        </div>
